...
@Getter
public class ContaCSVExporter implements CSVExporter<Conta> {

    private EntitiesFactory<Conta> repository;
    ...
    @Override
    public void setRepository(EntitiesFactory<Conta> repo) {
