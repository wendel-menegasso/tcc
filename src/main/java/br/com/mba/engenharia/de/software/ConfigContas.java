...
@Configuration
@EnableJpaRepositories(basePackageClasses = ContaRepositoryNovo.class)
public class ConfigContas {
    @Bean
    public DataSource dataSource() {
        DriverManagerDataSource dataSource = new DriverManagerDataSource();
        dataSource.setDriverClassName("com.mysql.jdbc.Driver");
        dataSource.setUrl("jdbc:mysql://root:fsa41306@localhost:3306/tcc");
        dataSource.setUsername("root");
        dataSource.setPassword("fsa41306");
