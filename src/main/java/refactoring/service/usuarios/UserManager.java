...
import refactoring.exceptions.ListarContaException;
import refactoring.repository.usuario.UsuarioRepository;
import refactoring.service.contas.ContaService;
...
public class UserManager implements UserService {
    ...
    public UserManager(UsuarioRepository usuarioRepositoryNovo) {
    ...
    @Override
    public void setRepository(UsuarioRepository usuarioRepositoryNovo) {
        this.usuarioRepositoryNovo = usuarioRepositoryNovo;
    }
